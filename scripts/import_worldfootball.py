...
KNOWN_TEAMS = {
    ...
    "FC Groningen": ("te385", "fc-groningen"),
    "FC Twente '65": ("te395", "fc-twente-enschede"),
    "FC Utrecht": ("te396", "fc-utrecht"),
    "sc Heerenveen": ("te397", "sc-heerenveen"),
    "PSV": ("te383", "psv-eindhoven"),
    "AFC Ajax": ("te393", "ajax-amsterdam"),
    "Feyenoord Rotterdam": ("te394", "feyenoord-rotterdam"),
    "AZ": ("te399", "az-alkmaar"),
